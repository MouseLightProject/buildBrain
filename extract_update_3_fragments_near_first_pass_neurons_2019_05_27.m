...
intermediate_results_folder_path = ...
    sprintf('/groups/mousebrainmicro/mousebrainmicro/cluster/Reconstructions/%s/build-brain-output/extract-update-3-fragments-near-first-pass-intermediate-results', ...
            sample_date) ;
output_swcs_folder_path = ...
    sprintf('/groups/mousebrainmicro/mousebrainmicro/cluster/Reconstructions/%s/build-brain-output/update-3-frags-near-first-pass-neurons', sample_date) ;
