input_folder_path = '/groups/mousebrainmicro/mousebrainmicro/cluster/Reconstructions/2019-10-04/build-brain-output/frags-from-take-2-trees-with-2-plus-nodes-as-mats' ;
output_file_path = '/groups/mousebrainmicro/mousebrainmicro/cluster/Reconstructions/2019-10-04/build-brain-output/all-frags-from-take-2-trees-with-2-plus-nodes.mat' ;
...
fragments_as_named_trees = horzcat(fragments_from_tree_id{:}) ;  

tic_id = tic() ;
save(output_file_path, 'fragments_as_named_trees', '-v7.3', '-nocompression') ;
elapsed_time = toc(tic_id) ;
