...
% Just hard-code the origin and spacing, since they're not in the .h5 p-map
origin_heckbertian = [0 0 0] ;  % um
spacing_at_full_zoom = [0.40625 0.40625 0.8125] ;  % um, this is from the raw data metadata.  The value in calculated_parameters.jl is bullshit
