function build_full_trees_as_mats_workflow1_2019_05_27()
    options.whole_brain_h5_p_map_file_path = '/nrs/mouselight/cluster/classifierOutputs/2019-05-27/whole-brain-p-map-as-h5/2019-05-27-whole-brain-p-map.h5' ;
    options.whole_brain_h5_p_map_dataset_path = '/prob0' ;
    options.whole_brain_h5_p_map_properties_group_path = '/prob0_props' ;
    options.skelfolder = '/nrs/mouselight/cluster/classifierOutputs/2019-05-27/skeletonization' ;

    options.outfolder = '/nrs/mouselight/cluster/classifierOutputs/2019-05-27/build-brain-output/full-as-mats' ;
