...
% -3:
is_melanin_from_fragment_index = (node_count_from_fragment_index<=25) & (fragment_count_within_radius_from_fragment_index>20) ;
...
figure('color', 'w') ;
plot3(centroid_xyz_from_melanin_fragment_index(:,1), centroid_xyz_from_melanin_fragment_index(:,2), centroid_xyz_from_melanin_fragment_index(:,3), '.k')
xlabel('x (um)') ;
ylabel('y (um)') ;
zlabel('z (um)') ;
...
figure('color', 'w') ;
plot(centroid_xyz_from_melanin_fragment_index(:,1), centroid_xyz_from_melanin_fragment_index(:,2), '.k')
xlabel('x (um)') ;
ylabel('y (um)') ;
xlim([min_xyz(1) max_xyz(1)]) ;
ylim([min_xyz(2) max_xyz(2)]) ;
