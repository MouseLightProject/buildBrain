function write_fragments_as_mats_given_named_tree(fragment_output_folder_path, ...
                                                  named_tree, ...
    ...
    % Write each fragment to to memory
...
%         save_swc_from_named_tree(fragment_swc_file_path, fragment_as_named_tree) ;
    ...
    % trim the array
    fragments_as_named_trees = raw_fragments_as_named_trees(is_fragment_valid) ;
