...
options.outfolder = ...
    sprintf('/groups/mousebrainmicro/mousebrainmicro/cluster/Reconstructions/%s/build-brain-output/full-as-named-tree-mats-debug', sample_date) ;
...
options.sizethreshold = 100 ;  % node count, before thinning/smoothing
...
build_full_trees_as_mats_workflow1_debug(options) ;
