function pred = graphshortestpath_pred_only(G,S,varargin)
...
if isempty(W)
    [~,pred] = graphalgs_exfiltrated(algorithmkeys{algorithm},debug_level,directed,G,S);
else
    [~,pred] = graphalgs_exfiltrated(algorithmkeys{algorithm},debug_level,directed,G,S,W);
end
